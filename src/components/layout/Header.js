...
import { useCard } from '../../contex/Card.js'
          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              </li>
              {
                !auth.user ? (<>
                  <li className="nav-item">
                    <NavLink to="/register" className="nav-link active" href="#">Register</NavLink>
                  </li><li className="nav-item">
                    <NavLink to="/login" className="nav-link active" href="#">Login</NavLink>
                  </li>
                </>) : (<>
                  <li className="nav-item dropdown">
              ...
              <li className="nav-item">
                ...
                <NavLink to="/card" className="nav-link active" href="#">Cart</NavLink>
                </Badge>
              </li>
