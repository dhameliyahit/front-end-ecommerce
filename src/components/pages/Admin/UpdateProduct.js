...
useEffect(()=>{
  ...
  const getAllCategory = async () => {
    try {
      ...
      console.log(error)
      toast.error('Somthin went wrong while getting category')
    }
  }
  useEffect(() => {
    getAllCategory();
      ...
      <div className="container-fluid m-3 p-3">
        ...
        <div className="row">
          ...
          <div className="col-md-9">
            ...
            <small>( if posible to all re-select category option )</small>
            <div className="m-1 w-75">
              ...
              <div className="mb-3">
                <label htmlFor="" className='btn btn-outline-secondary col-md-12'>

                  <input type="file" name='photo' className='mx-3' accept='image/*'
              ...
              <div className="mb-3">
                <textarea type="text" value={description} placeholder='Enter Product description'
                  className='form-control'
                  onChange={(e) => setDescription(e.target.value)}
                />
              </div>
              <div className="mb-3">
                <input type="number" value={price} placeholder='Enter Product Price in ₹.'
                  className='form-control'
